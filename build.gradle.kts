...
dependencies {
	...
	// SquidInk
	if (findProject(":SquidInk") != null) {
		implementation(project(":SquidInk"))
	} else {
		implementation(fg.deobf("dev.epicsquid.squidink:squidink:$squidInkVersion"))
	}
}
	...
	filesMatching(listOf("META-INF/mods.toml", "pack.mcmeta")) {
		expand(
			mapOf(
				...
				"squidInkVersion" to squidInkVersion,
				"lodestoneVersion" to lodestoneVersion
			)
		)
	}
}
